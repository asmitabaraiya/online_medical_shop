                            ...
                            <tbody>
                                ...
                                <tr class="text-white">
                                    ...
                                    <td >
                                        ...
                                        <a href="{{route('order.invoice.download' , $order->id)}}" class="waves-effect waves-light btn  btn-circle mx-5  btn-info"  ><i class="fa fa-download" title="Invoice Download"></i></a>                                        
