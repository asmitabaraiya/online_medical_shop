        ...
        <div class="col-6">
            ...
            <div class="box-body">
                            ...
                            <form method="post" action="{{ route('subcategory.update') }}"  >
                                ...
                                <input    name="id" type= "hidden" class="form-control" required="" value="{{$subcategory->id}}">
                                ...
                                <div class="row">
                                    <div class="col-12">                                   
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        <input type="text"  name="subcategory_name_hin" class="form-control" required="" value="{{$subcategory->subcategory_name_hin}}" >
