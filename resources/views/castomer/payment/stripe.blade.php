...
@if(session()->get('language') == 'hindi')  Stripe  @else Stripe @endif     
@endsection
...
var stripe = Stripe('pk_test_51KQUuQSHYHm4nKYTY4x6hdinwNi1xQpgAZSAsRO7MWUsxCQxlQpsAIpLfKPncrJ5YgWmcMNi92hMYykBGIKaIigM00iUCLeZiX');
